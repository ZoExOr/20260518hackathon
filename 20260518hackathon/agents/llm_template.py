...
Uses the team's OpenAI-compatible LiteLLM proxy. Swap models via AGENT_MODEL.
...
from restbench.llm_client import DEFAULT_LLM_MODEL, chat_completion

MODEL = os.getenv("AGENT_MODEL", DEFAULT_LLM_MODEL)
...
if __name__ == "__main__":
    if not (os.environ.get("RESTBENCH_LLM_API_KEY") or os.environ.get("OPENAI_API_KEY")):
        print("Set RESTBENCH_LLM_API_KEY or OPENAI_API_KEY first.")
